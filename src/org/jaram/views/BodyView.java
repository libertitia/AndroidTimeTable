...
//		a.recycle();
	...
	public boolean onTouchEvent(MotionEvent ev) {
		...
		case MotionEvent.ACTION_MOVE:
			if (mTouchState == TOUCH_STATE_REST) {
				...
				if (deltaX > 0 && mCurrentPage == getChildCount() - 1) {
					moveFirstViewToLast();
				} else if (deltaX < 0 && mCurrentPage == 0) {
					moveLastViewToFirst();
				}
	...
	private void moveLastViewToFirst() {
	...
	private void moveFirstViewToLast() {
	...
	public void snapToFirstBefore() {
		moveLastViewToFirst();
		snapToPage(mCurrentPage - 1);		
	}

	public void snapToLastAfter(){
		moveFirstViewToLast();
		snapToPage(mCurrentPage + 1);		
	}
